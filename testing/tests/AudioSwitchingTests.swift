...
final class AudioEngineSwitchingTests: XCTestCase {
    ...
    func testSettingsPersistenceRevertsOnFailure() {
        ...
        // Routing was written then... actually, in the no-prior-routing case,
        // the revert removes from appDeviceRouting but the settings manager
        // still has the value because the else branch doesn't clear settings
        // when previousDeviceUID is nil. This is documented in AudioEngineRoutingTests.
    }
